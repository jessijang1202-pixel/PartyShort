...
앞으로도 함께 목소리를 내고, 이 길을 이어가겠습니다. 감사합니다.`,
  ...
  slide_scenes: [
    ...
    },
    {
      ...
      visual_description: 'Vertical 9:16, Korean dawn or sunrise landscape, silhouette of a person standing and looking forward, hopeful mood, warm orange and gold sky, inspirational and forward-looking composition, minimal text space in lower third',
      duration_seconds: 7,
      imageStatus: 'idle',
    },
    {
      scene_id: 'slide_3',
      scene_title: '앞으로 우리가 함께 만들어갈 길',
      on_screen_text: '앞으로도 함께\n감사합니다 💙',
      narration_text: '앞으로도 함께 목소리를 내고, 이 길을 이어가겠습니다. 감사합니다.',
      visual_description: 'Vertical 9:16, diverse group of Korean people of different ages gathered warmly, community celebration or gathering, soft warm indoor or outdoor lighting, hopeful smiling faces, unity and solidarity feeling, clean modern Korean setting',
      duration_seconds: 6,
      imageStatus: 'idle',
    },
  ],
